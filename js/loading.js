// Inyecta los estilos del loader
...
// Crear botón e inyectarlo en el loader
...
// Mostrar el botón cuando el logo de AMBITV ya apareció (~2500ms)
setTimeout(function () {
    readyBtn.classList.add('visible');
}, 2500);

// Click en el botón → cerrar loader + disparar intro end
readyBtn.addEventListener('click', function () {
    readyBtn.style.display = 'none';
    var loader = document.getElementById('ambi-loader');
    if (typeof window.posicionarBleeds === 'function') window.posicionarBleeds();

    // Liberar scroll y arrancar música AL CLICK, no al final del fade
    document.documentElement.style.overflow = '';
    document.body.style.overflow = '';
    document.dispatchEvent(new Event('ambi:introEnd'));
